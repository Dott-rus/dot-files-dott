...
PanelWindow {
    ...
    readonly property string mode: shellRootController && shellRootController.mode !== undefined
        ? shellRootController.mode
        : "normal"
    ...
    FocusScope {
        ...
        Rectangle {
            ...
            readonly property real baseTargetWidth: {
                ...
                default:
                    if (root.mode !== "normal") return root.width;
                    return userConfig.islandWidth;
                }
            }
            ...
            Behavior on y { NumberAnimation { duration: mainCapsule.morphDuration; easing.type: Easing.OutQuint } }
            ...
            Item {
                ...
                Text {
                    ...
                    clip: true
                    text: {
                        const track = islandContainer.currentTrack;
                        const artist = islandContainer.currentArtist;
                        if (track && track !== "") {
                            if (artist && artist !== "")
                                return track + " - " + artist;
                            return track;
                ...
                Item { id: batteryCluster
                    anchors.right: parent.right
                    anchors.rightMargin: 20
                    anchors.verticalCenter: parent.verticalCenter
                    width: batteryLabel.implicitWidth + batteryIcon.implicitWidth + 6
                    height: parent.height
                    ...
                    Text {
                        ...
                        anchors.left: parent.left
                        anchors.verticalCenter: parent.verticalCenter
                        text: islandContainer.isCharging ? "\uf0e7" : "\uf240"
                        color: {
                            if (islandContainer.isCharging) return StyleTokens.warning;
                            if (islandContainer.batteryCapacity <= 10) return StyleTokens.danger;
                            if (islandContainer.batteryCapacity <= 20) return StyleTokens.warning;
                            return "white";
                        }
                        font.pixelSize: root.bodyFontSize
                        font.family: root.iconFontFamily
                    ...
                    Text {
                        ...
                        anchors.leftMargin: 4
                        anchors.verticalCenter: parent.verticalCenter
                        text: islandContainer.batteryCapacity + "%"
                        color: "white"
                        font.pixelSize: root.bodyFontSize
                        font.family: root.textFontFamily
                    }
